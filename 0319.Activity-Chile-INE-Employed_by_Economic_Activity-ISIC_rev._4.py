...
link_xls = list(df_files[df_files['Titulo'] == 'Serie: Personas ocupadas según rama de actividad económica']['Url'])
...
alphacast.datasets.dataset(319).upload_data_from_df(dfFinal, 
